...
color.forEach((coEx,index) => {
	console.log (`The index number is ${index + 1} 
		and the color type is ${coEx}`);
});


// Exercise 6 : Bank Details
// // Instructions
// In this exercise, you have to decide which type of variables you have 
// to use (ie. let or const):

// Create a global variable called bankAmount which value is
//  the amount of money currently in your account.
// Create a variable that saves the % amount of VAT (In Israel, it’s 17%).
// Create an array with all your monthly expenses, both positive
//  and negative (money made and money spent).
// Example : let details = ["+200", "-100", "+146", "+167", "-2900"]
// Create a program that modifies the expenses (ie. the positive AND 
...
details.forEach((detailWith,index) => {
	details[index] *= VAT 
}) 
console.log(details);
